...
HX_LOCAL_STACK_FRAME(_hx_pos_6e2080afb74ea209_121_nativeCallack,"glfw.GLFWMouseWheelHandler","nativeCallack",0xa477c30c,"glfw.GLFWMouseWheelHandler.nativeCallack","glfw/GLFW.hx",121,0x7145aa2f)
HX_LOCAL_STACK_FRAME(_hx_pos_6e2080afb74ea209_129_setCallback,"glfw.GLFWMouseWheelHandler","setCallback",0xe4f339ff,"glfw.GLFWMouseWheelHandler.setCallback","glfw/GLFW.hx",129,0x7145aa2f)
HX_LOCAL_STACK_FRAME(_hx_pos_6e2080afb74ea209_119_boot,"glfw.GLFWMouseWheelHandler","boot",0x01918eba,"glfw.GLFWMouseWheelHandler.boot","glfw/GLFW.hx",119,0x7145aa2f)
namespace glfw{
...
void GLFWMouseWheelHandler_obj::nativeCallack( GLFWwindow * win,Float x,Float y){
            	HX_STACKFRAME(&_hx_pos_6e2080afb74ea209_121_nativeCallack)
HXLINE( 122)		::String ptr = (::Std_obj::string(( ( ::Dynamic)(( (::cpp::Pointer<  GLFWwindow >)(win) )) )) + HX_("",00,00,00,00));
HXLINE( 123)		if (::glfw::GLFWMouseWheelHandler_obj::listeners->exists(ptr)) {
HXLINE( 124)			::glfw::GLFWMouseWheelHandler_obj::listeners->get(ptr)(x,y);
            		}
            	}
...
void GLFWMouseWheelHandler_obj::setCallback( GLFWwindow * win, ::Dynamic func){
            	HX_STACKFRAME(&_hx_pos_6e2080afb74ea209_129_setCallback)
HXDLIN( 129)		::Dynamic this1 = ::glfw::GLFWMouseWheelHandler_obj::listeners;
HXDLIN( 129)		( ( ::haxe::ds::StringMap)(this1) )->set((::Std_obj::string(( ( ::Dynamic)(( (::cpp::Pointer<  GLFWwindow >)(win) )) )) + HX_("",00,00,00,00)),func);
            	}
...
{
{
            	HX_GC_STACKFRAME(&_hx_pos_6e2080afb74ea209_119_boot)
HXDLIN( 119)		listeners =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
            	}
}
