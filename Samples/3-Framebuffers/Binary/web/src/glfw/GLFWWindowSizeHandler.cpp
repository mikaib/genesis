...
HX_LOCAL_STACK_FRAME(_hx_pos_838fdbe670a3d3af_157_nativeCallack,"glfw.GLFWWindowSizeHandler","nativeCallack",0x26b5da91,"glfw.GLFWWindowSizeHandler.nativeCallack","glfw/GLFW.hx",157,0x7145aa2f)
HX_LOCAL_STACK_FRAME(_hx_pos_838fdbe670a3d3af_163_setCallback,"glfw.GLFWWindowSizeHandler","setCallback",0xdbd5f644,"glfw.GLFWWindowSizeHandler.setCallback","glfw/GLFW.hx",163,0x7145aa2f)
HX_LOCAL_STACK_FRAME(_hx_pos_838fdbe670a3d3af_155_boot,"glfw.GLFWWindowSizeHandler","boot",0x8d687bd5,"glfw.GLFWWindowSizeHandler.boot","glfw/GLFW.hx",155,0x7145aa2f)
namespace glfw{
...
void GLFWWindowSizeHandler_obj::nativeCallack( GLFWwindow * win,int width,int height){
            	HX_STACKFRAME(&_hx_pos_838fdbe670a3d3af_157_nativeCallack)
HXLINE( 158)		::Dynamic this1 = ::glfw::GLFWWindowSizeHandler_obj::listeners;
HXDLIN( 158)		 ::Dynamic cb = ( ( ::haxe::ds::StringMap)(this1) )->get((HX_("win",1c,a8,5a,00) + ::Std_obj::string(( ( ::Dynamic)(( (::cpp::Pointer<  GLFWwindow >)(win) )) ))));
HXLINE( 159)		if (::hx::IsNotNull( cb )) {
HXLINE( 159)			::cpp::Pointer<  GLFWwindow > tmp = ( (::cpp::Pointer<  GLFWwindow >)(win) );
HXDLIN( 159)			cb(tmp,width,height);
            		}
            	}
...
void GLFWWindowSizeHandler_obj::setCallback( GLFWwindow * win, ::Dynamic cb){
            	HX_STACKFRAME(&_hx_pos_838fdbe670a3d3af_163_setCallback)
HXDLIN( 163)		::Dynamic this1 = ::glfw::GLFWWindowSizeHandler_obj::listeners;
HXDLIN( 163)		( ( ::haxe::ds::StringMap)(this1) )->set((HX_("win",1c,a8,5a,00) + ::Std_obj::string(( ( ::Dynamic)(( (::cpp::Pointer<  GLFWwindow >)(win) )) ))),cb);
            	}
...
{
{
            	HX_GC_STACKFRAME(&_hx_pos_838fdbe670a3d3af_155_boot)
HXDLIN( 155)		listeners =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
            	}
}
