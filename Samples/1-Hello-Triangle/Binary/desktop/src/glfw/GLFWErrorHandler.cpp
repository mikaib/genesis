...
HX_LOCAL_STACK_FRAME(_hx_pos_9c43973a46c03b53_33_nativeCallack,"glfw.GLFWErrorHandler","nativeCallack",0x0d39af16,"glfw.GLFWErrorHandler.nativeCallack","glfw/GLFW.hx",33,0x7145aa2f)
HX_LOCAL_STACK_FRAME(_hx_pos_9c43973a46c03b53_39_setCallback,"glfw.GLFWErrorHandler","setCallback",0x65252f89,"glfw.GLFWErrorHandler.setCallback","glfw/GLFW.hx",39,0x7145aa2f)
namespace glfw{
...
void GLFWErrorHandler_obj::nativeCallack(int error,const char* message){
            	HX_STACKFRAME(&_hx_pos_9c43973a46c03b53_33_nativeCallack)
HXLINE(  34)		 ::Dynamic _hx_tmp = ::haxe::Log_obj::trace;
HXDLIN(  34)		::String _hx_tmp1;
HXDLIN(  34)		if (::hx::IsNull( message )) {
HXLINE(  34)			_hx_tmp1 = HX_("null",87,9e,0e,49);
            		}
            		else {
HXLINE(  34)			_hx_tmp1 = ::String(message);
            		}
HXDLIN(  34)		_hx_tmp(((error + HX_(": ",a6,32,00,00)) + _hx_tmp1),::hx::SourceInfo(HX_("glfw/GLFW.hx",2f,aa,45,71),34,HX_("glfw.GLFWErrorHandler",70,b1,db,6d),HX_("nativeCallack",94,5e,6f,13)));
HXLINE(  35)		if (::hx::IsNotNull( ::glfw::GLFWErrorHandler_obj::cb )) {
HXLINE(  35)			::glfw::GLFWErrorHandler_obj::cb(error,::String(message));
            		}
            	}


void GLFWErrorHandler_obj::setCallback( ::Dynamic func){
            	HX_STACKFRAME(&_hx_pos_9c43973a46c03b53_39_setCallback)
HXDLIN(  39)		::glfw::GLFWErrorHandler_obj::cb = func;
            	}
