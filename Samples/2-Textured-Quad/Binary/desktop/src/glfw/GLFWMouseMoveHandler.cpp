...
HX_LOCAL_STACK_FRAME(_hx_pos_efcf35981be09ecc_85_nativeCallack,"glfw.GLFWMouseMoveHandler","nativeCallack",0x1bf08f48,"glfw.GLFWMouseMoveHandler.nativeCallack","glfw/GLFW.hx",85,0x7145aa2f)
HX_LOCAL_STACK_FRAME(_hx_pos_efcf35981be09ecc_93_setCallback,"glfw.GLFWMouseMoveHandler","setCallback",0x78733f3b,"glfw.GLFWMouseMoveHandler.setCallback","glfw/GLFW.hx",93,0x7145aa2f)
HX_LOCAL_STACK_FRAME(_hx_pos_efcf35981be09ecc_83_boot,"glfw.GLFWMouseMoveHandler","boot",0x8bd339fe,"glfw.GLFWMouseMoveHandler.boot","glfw/GLFW.hx",83,0x7145aa2f)
namespace glfw{
...
void GLFWMouseMoveHandler_obj::nativeCallack( GLFWwindow * win,Float x,Float y){
            	HX_STACKFRAME(&_hx_pos_efcf35981be09ecc_85_nativeCallack)
HXLINE(  86)		::String ptr = (::Std_obj::string(( ( ::Dynamic)(( (::cpp::Pointer<  GLFWwindow >)(win) )) )) + HX_("",00,00,00,00));
HXLINE(  87)		if (::glfw::GLFWMouseMoveHandler_obj::listeners->exists(ptr)) {
HXLINE(  88)			::glfw::GLFWMouseMoveHandler_obj::listeners->get(ptr)(x,y);
            		}
            	}
...
void GLFWMouseMoveHandler_obj::setCallback( GLFWwindow * win, ::Dynamic func){
            	HX_STACKFRAME(&_hx_pos_efcf35981be09ecc_93_setCallback)
HXDLIN(  93)		::Dynamic this1 = ::glfw::GLFWMouseMoveHandler_obj::listeners;
HXDLIN(  93)		( ( ::haxe::ds::StringMap)(this1) )->set((::Std_obj::string(( ( ::Dynamic)(( (::cpp::Pointer<  GLFWwindow >)(win) )) )) + HX_("",00,00,00,00)),func);
            	}
...
{
{
            	HX_GC_STACKFRAME(&_hx_pos_efcf35981be09ecc_83_boot)
HXDLIN(  83)		listeners =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
            	}
}
